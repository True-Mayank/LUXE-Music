...
if ($("#progress")) {
  ...
  // Android: the native MediaPlayer owns the real seek position. While the
  // user drags, only the slider moves. The actual seek is sent once on
  // release so the native state ticker cannot fight the finger.
