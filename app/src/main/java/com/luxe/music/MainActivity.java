...
public class MainActivity extends Activity {
    ...
    public class AndroidBridge {
        ...
        /**
         * Updates the Android notification and lock-screen media session with
         * the song currently displayed/played by the LUXE WebView.
         */
        @JavascriptInterface
        public void updatePlaybackNotification(
            ...
            long positionMs = Math.max(0L, (long) (positionSeconds * 1000.0));

            PlaybackKeepAliveService.updatePlayback(
                    title,
                    artist,
                    playing,
                    durationMs,
            ...
            runOnUiThread(() -> {
                try {
                    ...
                    webView.evaluateJavascript(
                            "(function(){try{var a=document.getElementById('audio');if(a){var p=a.play();" +
